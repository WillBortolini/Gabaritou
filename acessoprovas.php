...
<body>
    ...
    ?>
    <h2 class="text-center mb-1 mt-2">PROVAS DISPONIVEIS</h2>
    <?php
                ...
                <tr>
                    ...
                    while($exibir = $dadosprova->fetch_assoc()){
                        ...
                        <tr>
                            ...
                            <td><a href="gabarito.php?idprova_online=<?php echo $exibir["idprova_online"]?>" style="color: green"  title="Gabarito">Gabarito</td>
                        </tr>
